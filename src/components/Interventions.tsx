      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            OUR <span className="text-[hsl(var(--orange))]">PROCESS</span>
          </h2>
          <p className="text-muted-foreground max-w-3xl mx-auto">
            A comprehensive, step-by-step approach to rescuing, rehabilitating, and reintegrating street-connected youth while empowering communities.
          </p>
        </div>
